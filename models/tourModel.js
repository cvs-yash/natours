    ...
    priceDiscount:{
            ...
            validate : {
                validator :  function(val){
                    //this only points to the current doc on NEW dew creation
                return val < this.price; //100 < 200 if 250 is the discount price then we have to throw an validation error
            },
